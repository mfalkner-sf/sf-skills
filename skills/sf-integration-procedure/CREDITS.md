<!-- ABOUTME: Credits and acknowledgments for the sf-integration-procedure skill. -->
<!-- ABOUTME: Attributes sources from Salesforce OmniStudio documentation and community contributors. -->
